    ...
    <v-container>
      <v-row class="align-center justify-space-between">
        ...
        <v-col
          ...
          class="pr-0"
        >
          <div class="display-3 font-weight-bold mb-6">
            Write
            <span class="primary--text">code</span>, forget about the rest
          </div>
          <p class="title font-weight-regular mb-6">
            Deploy and scale modern apps and microservices without
            the complexities of DevOps and infrastructure management.
          </p>
          <v-row class="align-center">
            ...
            >
              <div>
                ...
                <div
                  class="v-overlay theme--dark"
                  style="z-index: 5; transition: none 0s ease 0s;"
                >
                  <div
                    class="v-overlay__scrim white"
                    style="opacity: 0;"
                  />
                </div>
              </div>
        ...
        <div
          class="col-md-5 offset-md-1 col-12"
        >
          <div
            class="box-shadow v-card v-sheet theme--light"
          >
            <div
            ...
            >
              <div
                ...
                style="height: 100%; left: 0px; position: absolute;
                top: 0px; width: 100%;"
              >
                <span
                  id="wistia-wz9mklec7c-1"
                  class="wistia_embed wistia_async_wz9mklec7c popover=true popoverAnimateThumbnail=false
                  ...
                  width: 469.75px;"
                    ...
                    >
                      <div
                        ...
                        style="height: 81px; position: absolute; width: 127px; z-index: 1; background-color: rgba(121, 110, 255, 0.8); left: 171px;
                  top: 92px;"
                      />
                      <div
                      ...
                      <img
                        ...
                        style="border: 0px; display: block; float: none; height: 264.219px; margin: 0px; max-height: none; max-width: none; padding: 0px; position: absolute; width: 469.75px; left: 0px; top: 0px;"
                      >
                    </div>
                  </div>
                </span>
...
.hero {
  padding: 16px 0 48px;
  background: linear-gradient(90deg,#fff 20px,#0000 1%) 50%,
    linear-gradient(#fff 20px,#0000 1%) 50%, #e8e8e8;
